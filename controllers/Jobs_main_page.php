...
//            echo json_encode(count($job_data) == 0 ? null : $job_data);
  ...
  //search job by city and category
  function search_job_union($query1,$query2){
    ...
    if (isset($query1)&&($query2)) {
        ...
        { 
            ...
            $job_data = $this->model->select_data_table3($query1,$query2, $page, $start, $limit);
        }
        else{
            $job_data = $this->model->select_data_table2($start, $limit);
        }
  ...
  ';
                ...
                if($previous_id > 0)
                {
                    $previous_link = '<a class="page-link" href="javascript:ajaxload1(`'.$query1.'`,`'.$query2.'`,'.$previous_id.')">Previous</a>';
                }
                else
                {
                    $previous_link = '
    ...
    ';
                ...
                {
                    $next_link = '
    <a class="page-link" href="javascript:ajaxload1(`'.$query1.'`,`'.$query2.'`,'.$next_id.')">Next</a>
    ';
                }
    ...
    ';
      ...
      <a class="page-link" href="javascript:ajaxload1(`'.$query1.'`,`'.$query2.'`,'.$page_array[$count].')">'.$page_array[$count].'</a>
