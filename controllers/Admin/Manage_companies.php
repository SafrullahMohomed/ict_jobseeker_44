...
class Manage_companies extends Controller
{
    ...
    function get_company_data()
    {
        ...
        if (isset($_POST["query"])) {
            ...
            if($_POST["query"] != '')
            {
                ...
                $company_data = $this->model->select_data_table($_POST["query"], $page, $start, $limit);
            }
            else{
                $company_data = $this->model->select_data_table2($start, $limit);
            }
	...
	';
            ...
            $total_links = ceil($company_data[1]/$limit);
