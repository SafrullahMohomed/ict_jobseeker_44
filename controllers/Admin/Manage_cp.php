...
//        error_reporting(0);
    ...
    //    to get the cprovider data
    function get_cprovider_data()
    {
        ...
        if (isset($_POST["query"])) {
            ...
            if($_POST["query"] != '')
            {
                ...
                $cprovider_data = $this->model->select_data_table($_POST["query"], $page, $start, $limit);
            }
            else{
                $cprovider_data = $this->model->select_data_table2($start, $limit);
            }
	...
	';
            ...
            $total_links = ceil($cprovider_data[1]/$limit);
...
//pagination page array ends here
	...
	';
            $output = array(
                'data'				=>	$cprovider_data[0],
                'pagination'		=>	$pagination_html,
                'total_data'		=>	$cprovider_data[1],
...
//        print "<pre>";
//        print_r($cprovider_data);
//        print "</pre>";

//            echo json_encode(count($cprovider_data) == 0 ? null : $cprovider_data);
        }
