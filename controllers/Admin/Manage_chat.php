...
class Manage_chat extends Controller
{
    ...
    //   echo "Hi";
        ...
        if (isset($_POST["query"])) {
            ...
            if($_POST["query"] != '')
            {
                ...
                $message_data = $this->model->select_data_table($_POST["query"], $page, $start, $limit);
            }
            else{
                $message_data = $this->model->select_data_table2($start, $limit);
            }
  ...
  ';
            ...
            $total_links = ceil($message_data[1]/$limit);
