...
alert("Your company profile company name also changes as above mentioned company name.If you want to change it click on the user icon in the top right corner then go to my profile and edit");
  }