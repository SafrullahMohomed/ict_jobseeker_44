    ...
    <div class="resume_page">
        ...
        <div class="leftbox">
            ...
            <div class="resume_header">
                ...
                <div class="candidate_phone candidate_personal_details"><i class="fa fa-phone" style="font-size:18px;color:white;width:20px"></i>
                    +94771234567</div>
            </div>
        ...
        <div class="rightbox">
            ...
            <div class="experience">
                ...
                <div class="experience2 experience_main">
                    ...
                    <div class="experience_employer">
                        <div class="experience_location">
                            <div class="experience_job_title">FRONT-END WEB DEVELOPER</div>
            ...
            <div class="project">
                ...
                <!-- project2 -->
                <div class="project2">
                    <div class="project_title">JAVA MOBILE APPLICATION</div>
                    <div class="project_details">
                        <ul>
                            <li>project point 1</li>
                            <li>project point 2</li>
