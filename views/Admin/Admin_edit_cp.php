...
<head>
    ...
    <link rel="stylesheet" href="/ict_jobseeker_44/views/CSS/Admin/Admin_edit_cp.css">
    <!-- <style>
...
<body>
    ...
    <form class="main_container" name="myForm" action="<?php echo URL ?>cp/insert_cp_data" method="post" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>>
        ...
        <div class="row">
            ...
            <span id="fname_error"><?php #echo  $_SESSION["fnameErr"] 
                                    ?></span>
        ...
        <div class="row">
            ...
            <span id="lname_error"><?php #echo  $_SESSION["lnameErr"]
                                    ?></span>
        </div>
        <div class="row">
            ...
            <span id="address_error"><?php #echo  $_SESSION["addressErr"] 
                                        ?></span>
        </div>
        <div class="row">
            ...
            <span id="phonenumber_error"><?php #echo   $_SESSION["phone_numberErr"] 
                                            ?></span>
        </div>
        <div class="row">
            ...
            <span id="nic_error"><?php #echo   $_SESSION["nicErr"]
                                    ?></span>
        ...
        <div class="row">
            ...
            <span id="brief_description_error"><?php #echo    $_SESSION["Brief_descriptionErr"]  
                                                ?></span>
        </div>
        ...
        <div class="row">
            ...
            <span id="email_error" class="error"><?php #echo   $_SESSION["emailErr"]
                                                    ?></span>
        </div>
        ...
        <div class="row">
            ...
            <span id="url_error"><?php #echo   $_SESSION["web_urlErr"] 
                                    ?></span>
        </div>
        ...
        <div class="row">
            ...
            <span id="fburl_error" class="error"><?php #echo   $_SESSION["fb_urlErr"] 
                                                    ?></span>
        </div>
        ...
        <div class="row">
            ...
            <span id="linkedin_url_error" class="error"><?php #echo  $_SESSION["linkedin_urlErr"] 
                                                        ?></span>
        ...
        <div class="row">
            ...
            <span id="twitter_url_error" class="error"><?php #echo  $_SESSION["twitter_urlErr "]
                                                        ?></span>
        </div>
