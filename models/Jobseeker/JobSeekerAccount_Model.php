...
class JobSeekerAccount_Model extends Model
{
    ...
    {
        $sql = "SELECT user.User_ID, Email, First_name, Last_name, Phone_number, Address, Profile_picture, Jobseeker_In, Jobseeker_Twitter, Jobseeker_Fb, Jobseeker_Web,  Description, Skills, Education, Experience, Gender, Age, Applied_jobs_count, Applied_contracts_count, Jobseeker_rate_total_star_count, Jobseeker_rate_and_review_count \n"
