...
class Manage_cp_Model extends Model
{
    ...
    function select_data_table($query, $page, $start, $limit)
    {
        ...
        $sample_data = array(
            ...
            ':Last_name' => '%' . $condition . '%',
            ':Contract_count' => '%' . $condition . '%',
            ':Phone_number' => '%' . $condition . '%'
        );



        $sql = "SELECT user.User_ID, Email, First_name, Last_name, Contract_count, Phone_number\n"
            . "FROM user\n"
            . "JOIN contractprovider ON user.User_ID = contractprovider.User_ID\n"
            . "WHERE user.User_ID LIKE :User_ID OR
                Email LIKE :Email OR
                First_name LIKE :First_name OR
                Last_name LIKE :Last_name OR
                Contract_count LIKE :Contract_count OR
...
//        to highlight the word
        ...
        foreach ($result as $row) {
            $data[] = array(
                ...
                'Contract_count' => str_ireplace($replace_array_1, $replace_array_2, $row["Contract_count"]),
...
//        declare an empty array
        $final = array();
        $sql2 = "SELECT user.User_ID, Email, First_name, Last_name, Contract_count, Phone_number\n"
